defmodule WabanexWeb.Schema.Types.Exercise do
  ...
  input_object :create_exercise_input do
    ...
    field :youtube_video_url, non_null(:string), description: "Exercise video"
    field :protocol_description, non_null(:string), description: "Exercise protocol (regular, biset, superset, dropset...) "
    field :repetitions, non_null(:string), description: "Number of series and repetitions"
  end
end
